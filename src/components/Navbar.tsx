...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="w-full px-8 lg:px-16 xl:px-24 relative">
        {/* Logo - Top Left Corner */}
        <motion.div
          className="absolute left-8 lg:left-16 xl:left-24 top-1/2 transform -translate-y-1/2 z-10"
        ...
        {/* Profile/Auth Section - Top Right Corner */}
        <div className="absolute right-8 lg:right-16 xl:right-24 top-1/2 transform -translate-y-1/2 z-10">
          {user ? (
            <div className="flex items-center space-x-3 lg:space-x-4">
              ...
              <motion.button
                onClick={logout}
                className="flex items-center space-x-2 px-3 lg:px-4 py-2 rounded-lg bg-red-500/20 text-red-400 hover:bg-red-500/30 transition-all duration-300 border border-red-500/30"
            ...
            <div className="flex items-center space-x-3 lg:space-x-4">
              ...
              >
                <Link href="/auth/login">
                  <motion.button
                    className="px-3 lg:px-4 py-2 rounded-lg text-white hover:text-green-400 transition-colors duration-300 text-sm lg:text-base font-medium"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
                    Login
              ...
              >
                <Link href="/auth/register">
                  <motion.button
                    className="px-4 lg:px-6 py-2 rounded-lg bg-gradient-to-r from-green-500 to-cyan-500 text-black font-semibold hover:from-green-400 hover:to-cyan-400 transition-all duration-300 shadow-lg hover:shadow-green-500/50 text-sm lg:text-base"
        ...
        <div className="flex items-center justify-center h-16 max-w-7xl mx-auto">
          {/* Spacer for Logo */}
          <div className="w-48 lg:w-56 xl:w-64"></div>
          ...
          <div className="flex items-center space-x-2 lg:space-x-4">
            {navItems.map((item, index) => (
              ...
              >
                <Link href={item.href}>
                  <motion.div
                    className="flex items-center space-x-2 px-3 lg:px-4 py-2 rounded-lg text-white hover:text-green-400 transition-all duration-300 relative group"
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                  >
