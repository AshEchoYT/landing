				...
				>
					{ctaButtons.map((button, index) => {
						...
						const classes = isPrimary
							...
							: "px-8 py-3 rounded-xl text-base font-medium bg-black text-white hover:shadow-[0_0_10px_rgba(16,185,129,0.4)] backdrop-blur-lg transition-all cursor-pointer";
