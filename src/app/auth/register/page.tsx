...
import { Zap, Eye, EyeOff, Mail, Lock, User, UserCheck } from 'lucide-react';
...
const RegisterPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-900 flex items-center justify-center px-4 py-8 relative overflow-hidden">
      ...
      >
        ...
        >
          ...
          <p className="text-gray-400 text-sm">Create your account and start exploring amazing events</p>
        </motion.div>
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
            ...
            >
              <label className="block text-white mb-3 font-medium text-sm">Full Name</label>
            ...
            >
              <label className="block text-white mb-3 font-medium text-sm">I am a...</label>
              <div className="relative">
                <select
                  name="role"
                  value={formData.role}
                  onChange={handleChange}
                  className="w-full px-4 py-3 pl-12 bg-gray-700/50 border border-green-500/30 text-white rounded-xl focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all duration-300 appearance-none"
                >
                  <option value="attendee">🎟️ Event Attendee</option>
                  <option value="organizer">🎪 Event Organizer</option>
                </select>
                <UserCheck className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-green-400" />
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-green-500/10 to-cyan-500/10 rounded-xl opacity-0 focus-within:opacity-100 transition-opacity duration-300 pointer-events-none"
                  animate={{ opacity: [0, 0.1, 0] }}
                  transition={{ duration: 2, repeat: Infinity }}
            ...
            >
              <label className="block text-white mb-3 font-medium text-sm">Confirm Password</label>
              <div className="relative">
                <input
